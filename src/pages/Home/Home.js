  ...
  return (
    <>
      ...
      <section className="torSection">
        <a className="torTitle" rel="noreferrer" href="https://www.torproject.org/" target="_blank">
        ...
        <div className="torDiv">
          ...
          <div>
            <p>
              ...
              your internet traffic to be encrypted three times as it passes
              over the Tor network. This allows for you, the user, to browse the
              web completely anonymously. Tor strives to make all it's users
              look the same, which will make it challening for anyone to track
              you based on your browser or device information.
            </p>
            <p>
              Interested in turning your node into a Tor relay server? Click{" "}
              <a className="torServerLink"
                rel="noreferrer"
